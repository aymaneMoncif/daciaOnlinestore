...
<body>
    ...
    <div class="content" style="margin: 40px;">
        ...
        <p style="font-family: NouvelRRegular;">Votre apport a été bien reçu.
            Nous vous prions de patienter, une fois votre paiement de précommande est accepté, un email de validation vous sera envoyé.    
        </p>
