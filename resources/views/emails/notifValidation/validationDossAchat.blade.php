...
<body>
    ...
    <div class="content" style="margin: 40px;">
        ...
        <p style="font-family: NouvelRRegular;">Votre conseiller Renault vous contactera très prochainement pour vous communiquer les modalités de livraison de votre véhicule.    
        </p>

        <a href="http://127.0.0.1:8000/paiement" style="font-family: NouvelRRegular;
                          margin: 28px auto;
                          height: 46px;
                          display: flex;
                          align-items: center;
