...
<body>
    ...
    <div class="content" style="margin: 40px;">
        ...
        <p style="font-family: NouvelRBold;">Bonjour <span style="font-family: NouvelRRegular;">{{$CommercialName}}</span></p>

        <p style="font-family: NouvelRBold;">Nom client : &nbsp;<span style="font-family: NouvelRRegular;">{{$name}}&nbsp;{{$prenom}}</span></p>

        <p style="font-family: NouvelRBold;">Modèle : &nbsp;<span style="font-family: NouvelRRegular;">{{$nommodele}}</span></p>

        <p style="font-family: NouvelRBold;">Version : &nbsp;<span style="font-family: NouvelRRegular;">{{$nomversion}}</span></p>

        <p style="font-family: NouvelRBold;">Financement : &nbsp;<span style="font-family: NouvelRRegular;">{{$financement}}</span></p>

        <p style="font-family: NouvelRBold;">Statut Call center : &nbsp;<span style="font-family: NouvelRRegular;">{{$CC_status}}</span></p>

        <p style="font-family: NouvelRBold;">Date de statut : &nbsp;<span style="font-family: NouvelRRegular;">{{$Date_status}}</span></p>
