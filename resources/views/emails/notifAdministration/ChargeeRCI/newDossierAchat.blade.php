...
<body>
    ...
    <div class="content" style="margin: 40px;">
        ...
        <p style="font-family: NouvelRBold;">Bonjour <span style="font-family: NouvelRRegular;">{{$RCIName}}</span></p>

        <p style="font-family: NouvelRBold;">Nom client : &nbsp;<span style="font-family: NouvelRRegular;">{{$name}}&nbsp;{{$prenom}}</span></p>

        <p style="font-family: NouvelRBold;">Date de dépôt de dossier : &nbsp;<span style="font-family: NouvelRRegular;">{{$DateDepot}}</span></p>
