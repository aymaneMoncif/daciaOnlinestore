...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('webStyle/style/home.css') }}">
    <link rel="stylesheet" href="{{ asset('webStyle/style/changePSW.css') }}">
    <link rel="stylesheet" href="{{ asset('webStyle/style/global.css') }}">
    <link rel="stylesheet" href="{{ asset('webStyle/style/CMDvalidation.css') }}">
    <link rel="stylesheet" href="{{ asset('webStyle/style/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('webStyle/style/owl.theme.default.min.css') }}">

    @yield('headScript')
    <title>@yield('title')</title>
    <title>M-Automotive</title>
        ...
        <div class="header_container">
                    ...
                    <div class="menu_row">
                        <div class="menu_carcard">
                            <a href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouveau_duster">
                                <img src="{{ asset('menuCars/Duster.png') }}" alt="" />
                                <div>
                                    <p class="carName">DUSTER</p>
                                    <p class="carPrice">à partire de 210 000 MAD</p>
                                </div>
                             </a>
                        </div>
                        <div class="menu_carcard">
                            <a href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouvelle-sandero-streetway">
                                <img src="{{ asset('menuCars/Streetway.png') }}" alt="" />
                                <div>
                                    <p class="carName">SANDERO STREETWAY</p>
                                    <p class="carPrice">à partire de 150 000 MAD</p>
                                </div>
                            </a>
                        </div>
                        <div class="menu_carcard">
                            <a href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouvelle-logan">
                                <img src="{{ asset('menuCars/Logan.png') }}" alt="" />
                                <div>
                                    <p class="carName">LOGAN</p>
                                    <p class="carPrice">à partire de 132 000 MAD</p>
                                </div>
                            </a>
                        </div>
                        <div class="menu_carcard">
                            <a href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouvelle-stepway">
                                <img src="{{ asset('menuCars/Stepway.png') }}" alt="" />
                                <div>
                                    <p class="carName">SANDERO STEPWAY</p>
                                    <p class="carPrice">à partire de 141 000 MAD</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="menu_row">
                        <div class="menu_carcard">
                            <a href="https://dacia.m-automotiv.ma/fr/gamme/modele/spring">
                                <img src="{{ asset('menuCars/Spring.png') }}" alt="" />
                                <div>
                                    <p class="carName">SPRING</p>
                                    <p class="carPrice">à partire de 200 000 MAD</p>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div id="MobileMenu1" class="header_right">
                ...
                <div class="mobile_arrange">
                    <ul class="nav_list">
                        <li class="mobileDisplay">Dacia Maroc</li>
                        ...
                        <div id="megaMenuVPMobile" class="mega_menu_mobile">
                            <div class="menu_carlist">
                                <div class="menu_carcard">
                                    <a class="carLink" href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouveau_duster">
                                        <img src="{{ asset('menuCars/Duster.png') }}" alt="" />
                                        <div>
                                            <p class="carName">DUSTER</p>
                                            <p class="carPrice">à partire de 210 000 MAD</p>
                                ...
                                <div class="menu_carcard">
                                    <a class="carLink" href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouvelle-sandero-streetway">
                                        <img src="{{ asset('menuCars/Streetway.png') }}" alt=""/>
                                        <div>
                                            <p class="carName">SANDERO STREETWAY</p>
                                            <p class="carPrice">à partire de 150 000 MAD</p>
                                ...
                                <div class="menu_carcard">
                                    <a class="carLink" href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouvelle-logan">
                                        <img src="{{ asset('menuCars/Logan.png') }}" alt=""/>
                                        <div>
                                            <p class="carName">LOGAN</p>
                                            <p class="carPrice">à partire de 132 000 MAD</p>
                                ...
                                <div class="menu_carcard">
                                    <a class="carLink" href="https://dacia.m-automotiv.ma/fr/gamme/modele/nouvelle-stepway">
                                        <img src="{{ asset('menuCars/Stepway.png') }}" alt="" />
                                        <div>
                                            <p class="carName">SANDERO STEPWAY</p>
                                            <p class="carPrice">à partire de 141 000 MAD</p>
                                ...
                                <div class="menu_carcard">
                                    <a class="carLink" href="https://dacia.m-automotiv.ma/fr/gamme/modele/spring">
                                        <img src="{{ asset('menuCars/Spring.png') }}" alt="" />
                                        <div>
                                            <p class="carName">SPRING</p>
                                            <p class="carPrice">à partire de 200 000 MAD</p>
                    ...
                    <a href="https://m-automotiv.ma" class="right_logo desktopDisplay">
                        <img src="{{ asset('menuCars/m-automotiv.png') }}" class="right_logo_img" xmlns="http://www.w3.org/2000/svg" id="Calque_1" data-name="Calque 1" version="1.1" viewBox="0 0 173.68 32.66" style="fill: #646b52; strokeWidth: 0px; width: 100%" />
                    </a>
                </div>
            </div>
                ...
                <div class="f_top_section_content desktopDisplay">
                    ...
                    <div class="footer_block">
                        ...
                        <div class="tagSession">
                            <div class="imageZone">
                                <img src="{{ asset('menuCars/tag.png') }}" alt="" />
                            </div>
                            <div class="textzone">
                                <p>
