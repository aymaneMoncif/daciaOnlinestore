                        ...
                        <div class="card3">
                            <div class="card-body">
                                ...
                                <p className="card-text">Pour garantir la sécurité de ses clients et futurs clients,
                                    <span style="white-space: nowrap">M-AUTOMOTIV</span> assurent un processus d'achat de votre véhicule complètement digitalisé à travers la plateforme en ligne d'achat garantie par <span style="white-space: nowrap">M-AUTOMOTIV</span> Maroc.
                    ...
                    <div class="Garanties_card">
                        <div class="card3">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Pour vous assurer une expérience personnalisée, M-AUTOMOTIV met à votre disposition la possibilité de discuter avec votre conseiller commercial tout au long de votre parcours, afin de vous rassurer concernant vos choix.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="Garanties_card">
                        <div class="card3">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Toutes les procédures mises en place sur cette plateforme respectent nos conditions de vente actuelles et garantissent la sécurité de vos données personnelles conformément aux règles établies par le CNDP. Vous serez en contact permanent avec nos équipes commerciales pour bénéficier d'une transparence totale et d'un accompagnement tout au long de ce processus.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card3">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"> Pour garantir la sécurité de ses clients et futurs clients,
                                        <span style="white-space: nowrap">M-AUTOMOTIV</span> ssure un processus d'achat de véhicule entièrement numérique via sa plateforme en ligne garantie par <span style="white-space: nowrap">M-AUTOMOTIV</span> Maroc.
                    ...
                    <div class="card">
                        ...
                        <div id="collapsenine" class="collapse" aria-labelledby="headingnine" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                Pour garantir la sécurité de ses clients et futurs clients, <span style="white-space: nowrap">M-AUTOMOTIV</span> assure un processus d'achat de véhicule entièrement numérique via sa plateforme en ligne garantie par <span style="white-space: nowrap">M-AUTOMOTIV</span> Maroc<br />
                                ...
                                Pour vous assurer une expérience personnalisée, <span style="white-space: nowrap">M-AUTOMOTIV</span> met à votre disposition la possibilité de discuter avec votre conseiller commercial tout au long de votre parcours, afin de vous rassurer concernant vos choix. <br />
