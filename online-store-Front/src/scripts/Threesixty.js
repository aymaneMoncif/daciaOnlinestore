...
;(function ( $, window, document, undefined ) {
    ...
    var scope,
        ...
        // Declare autoScrollInterval outside of the function
        ...
        $(document).ready(function(){
            ...
            $('.play').click(function(){
                ...
                $('.handCircle').stop().animate({opacity:0}, 300);
            });
    
            $('.stop').click(function(){
                // Stop auto-scrolling if needed
                console.log("Stop");
                clearInterval(autoScrollInterval);
                // Show the play button and hide the stop button
                $('.play').css('display', 'block');
                $('.stop').css('display', 'none');
                $('.handCircle').stop().animate({opacity:1}, 300);
            });
    
            $('.zoomIn').click(function(){
                $('.threeSixty_size_zoomIn').css('display', 'block');
            });
            $('.zoomOut').click(function(){
                $('.threeSixty_size_zoomIn').css('display', 'none');
            });
            ...
            $threeSixty.on('down', function(){
                $('.ui, .handCircle, h1, h2, .label, .examples').stop().animate({opacity:0}, 300);
            });
    
            $threeSixty.on('up', function(){
                $('.ui, .handCircle, h1, h2, .label, .examples').stop().animate({opacity:1}, 500);
            });
        });
