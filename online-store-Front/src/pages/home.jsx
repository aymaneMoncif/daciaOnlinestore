...
export default function Home(){
    useEffect(() => {
        ...
        script.src = 'src/scripts/homePage.js';
        script.async = true;
        document.body.appendChild(script);

        // Clean up function to remove the scripts and styles when the component unmounts
        return () => {
    ...
    return(
        ...
        <div className="breadcrumb_Container">
            <div className="breadcrumb">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="bi bi-chevron-right" viewBox="0 0 16 16">
        ...
        <div className="header_image">
            <div className="carousel_title">
                ...
                <div className="button-zone">
                    <a href="http://localhost:3000/Modele"><button className="btn1">Je commande mon véhicule</button></a>
                </div>
            </div>
        </div>


        <div className="M-auto-renault_containerT">
            <div className="M-auto-renault">
                <div className="owl-carousel" id="carousel5">
                        ...
                        <div className="item">
                            <div className="mini-card">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Calque_1" data-name="Calque 1" viewBox="0 0 100 100" width="100" height="100" style={{fill: '#000000'}}>
                                    <path className="cls-1" d="M30.58,74.73c-3.57,0-5.27-1.71-5.27-5.27v-26.51c0-3.56,1.71-5.27,5.27-5.27h38.83c3.56,0,5.27,1.71,5.27,5.27v26.51c0,3.56-1.71,5.27-5.27,5.27H30.58ZM69.05,71.68c1.86,0,2.6-.89,2.6-2.82v-25.39c0-1.93-.74-2.82-2.6-2.82H30.95c-1.86,0-2.6.89-2.6,2.82v25.39c0,1.93.74,2.82,2.6,2.82h38.09ZM31.4,25.27h8.84c3.79,0,5.35.37,7.28,2.6l3.04,3.49h17.97v3.04h-19.53l-3.12-3.86c-1.48-1.86-2.38-2.23-5.64-2.23h-5.79v6.09h-3.04v-9.13ZM34.52,49.93h24.72v-3.04h-24.72v3.04ZM34.52,56.09h12.4v-3.04h-12.4v3.04Z"/>
                                </svg>
                                <p className="minicard-title">3. COMPLÉTEZ VOTRE DOSSIER D'ACHAT</p>
                                <p className="minicard-desc"> Renseignez les documents nécessaires pour compléter votre dossier d'achat via votre espace personnel et depuis chez vous.</p>
                            </div>
                        </div>
        ...
        <div className="M-auto-renault_container" >
            <div className="M-auto-renault" >
                <div className="row6i">
        ...
        <div className="button_container">
            <div className="button_zone">
                <Link className="comande_vehicule" to={'/Modele'}>Je commande mon véhicule</Link>
            </div>
        </div>

        <div className="prqEnLigne_conatiner mobile">
            <div className="prqEnLigne_zone">
                <div className="mainTitle">
                    <p className="title">Pourquoi acheter en ligne</p>
                </div>
                <div className="icons_text_container">
                    <div className="owl-carousel" id="carousel6">
                        <div className="item">
                            <div className="svg_containerANDtext">
                                <div className="svg_container">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="icon" data-name="Calque 1" viewBox="0 0 100 100" width="65" height="65">
                                        <path className="cls-1" d="M50,78.3c-16.18,0-26.97-12.15-26.97-28.26s10.79-28.33,26.97-28.33,26.96,12.23,26.96,28.33-10.79,28.26-26.96,28.26ZM50,75.49c14.38,0,24.01-10.93,24.01-25.46s-9.64-25.53-24.01-25.53-24.02,10.93-24.02,25.53,9.71,25.46,24.02,25.46ZM41.01,48.81c-3.89,0-6.04-2.95-6.04-7.77s2.15-7.77,6.04-7.77,6.04,2.95,6.04,7.77-2.16,7.77-6.04,7.77ZM38.14,41.05c0,3.45.86,5.03,2.88,5.03s2.88-1.58,2.88-5.03-.86-5.03-2.88-5.03-2.88,1.58-2.88,5.03ZM40.94,66.5l15.17-32.94h2.88l-15.1,32.94h-2.95ZM58.99,66.79c-3.88,0-6.04-2.95-6.04-7.77s2.16-7.77,6.04-7.77,6.04,2.95,6.04,7.77-2.15,7.77-6.04,7.77ZM56.11,59.02c0,3.45.86,5.03,2.88,5.03s2.88-1.58,2.88-5.03-.86-5.03-2.88-5.03-2.88,1.58-2.88,5.03Z"/>
                                    </svg>
                                </div>
                                <p className="text">
                        ...
                        <div className="item">
                            <div className="svg_containerANDtext">
                                <div className="svg_container">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="icon" data-name="Calque 1" viewBox="0 0 100 100" width="65" height="65">
                                        <path className="cls-1" d="M47.68,76.52c-2.33,0-3.77-1.21-4.17-3.3-7.7-1.45-12.27-6.11-12.91-13.02-4.57-.72-7.3-4.42-7.3-10.05,0-6.35,3.29-9.97,9.06-9.97h1.04v-.88c0-10.13,6.17-15.83,16.6-15.83s16.68,5.71,16.68,15.83v.88h1.04c5.69,0,8.98,3.7,8.98,9.97s-3.61,10.21-9.38,10.21h-3.93v-21.06c0-8.12-4.65-12.54-13.39-12.54s-13.31,4.5-13.31,12.54v21.06h-2.65c.56,5.14,3.69,8.2,9.62,9.32.56-1.77,1.84-2.65,4.01-2.65,3.77,0,5.69,1.61,5.69,4.82s-2,4.66-5.69,4.66ZM33.4,56.99v-13.42h-1.04c-3.93,0-5.77,2.17-5.77,6.59s2,6.83,5.77,6.83h1.04ZM66.68,43.57v13.42h.64c4.01,0,6.09-2.41,6.09-6.83s-2-6.59-6.09-6.59h-.64Z"/>
                                    </svg>
                                </div>
                                <p className="text">
        ...
        <div className="prqEnLigne_conatiner">
            <div className="prqEnLigne_zone">
                <div className="mainTitle">
                    <p className="title">Pourquoi acheter en ligne</p>
                </div>
        ...
        <div className="row_1i">
            <div className="mainTitle">
                <p className="title">Nos garanties</p>
            </div>
        </div>

        <div className="Garanties_card_hide">
            <div className="Garanties_card_zone">
        ...
        <div className="row_1i">
            <div className="mainTitle">
                <svg xmlns="http://www.w3.org/2000/svg" id="Calque_1" dataname="Calque 1" version="1.1" viewBox="0 0 100 100" width='55' height='55' fill='#646b52'>
                    <path className="cls-2" d="M48.3,83.02c-1.45,2.69-3.21,5.28-4.87,7.35h-4.56c-1.66-2.07-3.42-4.66-4.87-7.35h-13.47c-4.45,0-7.36-2.9-7.36-7.35v-41.44c0-4.35,3.01-7.25,7.36-7.25h41.44c4.87,0,7.36,2.49,7.36,7.35v41.34c0,4.66-2.9,7.35-7.56,7.35h-13.47ZM41.16,86.75c1.66-2.39,2.9-4.97,4.25-7.88h15.85c2.49,0,3.83-1.35,3.83-3.63v-40.51c0-2.38-1.35-3.63-3.73-3.63H21.06c-2.18,0-3.62,1.35-3.62,3.52v40.61c0,2.17,1.45,3.63,3.62,3.63h15.85c1.35,2.9,2.59,5.49,4.25,7.88ZM74,70.07V26.14c0-2.38-1.35-3.63-3.73-3.63H26.14v-4.14h44.76c4.87,0,7.35,2.49,7.35,7.35v44.34h-4.25ZM82.9,61.37V17.44c0-2.39-1.35-3.63-3.73-3.63h-44.44v-4.15h45.06c4.87,0,7.36,2.49,7.36,7.35v44.34h-4.25Z"/>
                    <path className="cls-1" d="M42.56,43.25c-2.52-.01-5.02.44-7.39,1.32v-2.81c2.38-.82,4.87-1.27,7.39-1.33,4.97,0,7.95,2.73,7.95,7.12.13,2.48-.87,4.89-2.73,6.53l-1.33,1.48c-2.1,2.33-2.41,3-2.41,5.23v2.32h-2.96v-2.32c-.27-2.31.63-4.61,2.41-6.12l1.68-1.74c1.52-1.35,2.42-3.26,2.48-5.29,0-2.66-2.07-4.39-5.1-4.39Z"/>
                    <path className="cls-1" d="M44.79,68.24c0,1.57-.65,2.32-2.31,2.32-1.1.18-2.14-.57-2.32-1.68-.03-.21-.03-.43,0-.64,0-1.66.74-2.32,2.32-2.32s2.35.66,2.35,2.32h-.04Z"/>
                </svg>
                <p className="title exeption">Foire aux questions "online store"</p>
                <p className="semititle">Vos questions sur online store</p>
            </div>
        </div>
        <div className="row_1i_questions">
            <div className="questions-section">
                <div id="accordion">
                    <div className="card">
                        <div className="card-header1 bg-black" id="headingOne">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Est-ce que le stock véhicule est visible ?
                                <svg className="rotate-icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingTwo">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div className="card-bodyhome">
                                ...
                                Si vous souhaitez voir nos véhicules d'occasion disponibles, vous pouvez les consulter sur le lien <a href="https://renault.m-automotiv.ma/Gammevo">https://renault.m-automotiv.ma/Gammevo</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingThree">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingfore">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapsefore" aria-expanded="false" aria-controls="collapsefore">
                        ...
                        <div id="collapsefore" className="collapse" aria-labelledby="collapsefore" data-parent="#accordion">
                            <div className="card-bodyhome">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingfive">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingsixe">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapsesixe" aria-expanded="false" aria-controls="collapsesixe">
                        ...
                        <div id="collapsesixe" className="collapse" aria-labelledby="headingsixe" data-parent="#accordion">
                            <div className="card-bodyhome">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingseven">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapseseven" aria-expanded="false" aria-controls="collapseseven">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingeight">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">
                                Peut on faire une reprise de notre voiture avec une véhicule neuf ou occasion ?
                                <svg className="rotate-icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" d="M1.646 2.646a.5.5 0 01.708 0L8 8.293l5.646-5.647a.5.5 0 01.708.708l-6 6a.5.5 0 01-.708 0l-6-6a.5.5 0 010-.708z" clipRule="evenodd"/>
                                </svg>
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingnine">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapsenine" aria-expanded="false" aria-controls="collapsenine">
                                Quelles sont les garanties proposées par <span style={{whiteSpace: 'nowrap'}}>&nbsp; M-AUTOMOTIV &nbsp;</span> Maroc ?
                                <svg className="rotate-icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" d="M1.646 2.646a.5.5 0 01.708 0L8 8.293l5.646-5.647a.5.5 0 01.708.708l-6 6a.5.5 0 01-.708 0l-6-6a.5.5 0 010-.708z" clipRule="evenodd"/>
                                </svg>
                            </button>
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingten">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapseten" aria-expanded="false" aria-controls="collapseten">
                    ...
                    <div className="card">
                        <div className="card-header1" id="headingeleven">
                            <h5 className="mb-0">
                            <button className="btn btn-linkquestions collapsed exept" data-toggle="collapse" data-target="#collapseeleven" aria-expanded="false" aria-controls="collapseeleven">
